...
ACLOCAL = ${SHELL} '/root/suricata-7.0.5/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/root/suricata-7.0.5/missing' autoconf
AUTOHEADER = ${SHELL} '/root/suricata-7.0.5/missing' autoheader
AUTOMAKE = ${SHELL} '/root/suricata-7.0.5/missing' automake-1.16
AWK = gawk
CARGO = /usr/bin/cargo
CARGO_BUILD_TARGET = 
...
LIBOBJS = 
LIBS = -llz4 -lmagic -lcap-ng -lelf -lpcap -lnet -ljansson -lpthread -lyaml -lpcre2-8  -lz -lpcap 
...
LUA_LIBS = 
MAJOR_MINOR = 7.0
MAKEINFO = ${SHELL} '/root/suricata-7.0.5/missing' makeinfo
MANIFEST_TOOL = :
...
VERSION = 7.0.5
abs_builddir = /root/suricata-7.0.5
abs_srcdir = /root/suricata-7.0.5
abs_top_builddir = /root/suricata-7.0.5
abs_top_srcdir = /root/suricata-7.0.5
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
e_rustdir = /root/suricata-7.0.5/rust
...
install_sh = ${SHELL} /root/suricata-7.0.5/install-sh
...
AM_CPPFLAGS = -I$(srcdir)/src/socket
all: all-recursive
